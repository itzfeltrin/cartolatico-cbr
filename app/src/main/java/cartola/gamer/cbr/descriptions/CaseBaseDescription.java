...
public class CaseBaseDescription implements CaseComponent {
	...
	public String toString() {
		return "CaseBaseDescription{" + "id=" + id + ", codigo=" + codigo + ", tipo_incidente=" + tipo_incidente
				+ ", hora_deteccao='" + hora_deteccao + '\'' + ", ip_origem='" + ip_origem + '\'' + ", portas_origem='"
				+ portas_origem + '\'' + ", url_maliciosa='" + url_maliciosa + '\'' + ", hostname_origem='"
				+ hostname_origem + '\'' + ", ip_cc='" + ip_cc + '\'' + ", porta_cc='" + porta_cc + '\''
				+ ", hostname_cc='" + hostname_cc + '\'' + ", nome_malware_falha='" + nome_malware_falha + '\''
				+ ", titulo='" + titulo + '\'' + ", tamanho='" + tamanho + '\'' + ", protocolo='" + protocolo + '\''
				+ ", sistema_operacional=" + sistema_operacional + ", conta='" + conta + '\'' + ", informacoes='"
				+ informacoes + '\'' + ", aplicacao='" + aplicacao + '\'' + ", tentativas=" + tentativas
				+ ", tratamento_sugerido='" + tratamento_sugerido + '\'' + ", diagnostico_inicial='"
				+ diagnostico_inicial + '\'' + ", passos='" + passos + '\'' + '}';
	}
}
